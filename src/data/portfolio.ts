...
export const portfolioData: PortfolioData = {
    ...
    about: {
        ...
        note: "Estou ciente de que sou novo no mercado de trabalho, mas a minha experiência na faculdade e em projetos freelancers me deram a base para evoluir para um dev júnior.",
        cards: [
            { id: 1, icon: "award", title: "Carreira em ascensão", description: "Em busca da primeira oportunidade para decolar na carreira dev." },
